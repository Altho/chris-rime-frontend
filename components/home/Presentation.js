        ...
        <div>
            <div className={style.presentationContainer}>
                ...
                <div className={`${style.paragraph} ${drawer(1)}`} >
                    ...
                    Télé, les jeux vidéo et le cinema.
                </div>
                    <div className={style.readBtnContainer}>
                        <Button color="orange" variant={"outline"} onClick={isOpened === 1 ?() => setIsOpened(0) :() => setIsOpened(1)}>{isOpened === 1 ? textOpened() : textClosed()}</Button>
                ...
                <div className={style.icon}>
                    ...
                    Croisille, Tairo, Axel Tony, Bijou ...
                </div>
                    <div className={style.readBtnContainer}>
                        <Button color="orange" variant={"outline"} onClick={isOpened === 2 ?() => setIsOpened(0) :() => setIsOpened(2)} >{isOpened === 2 ? textOpened() : textClosed()}</Button>
                    </div>
                </div>
                ...
                <div className={style.icon}>
                    ...
                    <div className={style.readBtnContainer}>
                        <Button color="orange" variant={"outline"} onClick={isOpened === 3 ?() => setIsOpened(0) :() => setIsOpened(3)} >{isOpened === 3 ? textOpened() : textClosed()}</Button>
                    </div>
                </div>
